...
- [ ] Compactar horários na conversa e corrigir a resposta automática após duas mensagens seguidas, sem botão de retomada; correção aplicada, falta validar o fluxo real após publicação.
