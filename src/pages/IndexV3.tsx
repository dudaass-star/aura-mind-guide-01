        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              ...
              {"@type": "Question", "name": "A AURA é terapia?", "acceptedAnswer": {"@type": "Answer", "text": "Não. A AURA é apoio no dia a dia: conversa contínua, memória do seu percurso e direção prática. Ela não faz diagnóstico, não substitui atendimento profissional e não se apresenta como tratamento."}},
