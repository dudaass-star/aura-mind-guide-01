UPDATE public.whatsapp_templates
   SET meta_template_name = 'relatorio_semanal',
       ...
       meta_variable_names = NULL,
       is_active = true
 WHERE category = 'weekly_report';

UPDATE public.whatsapp_templates
   SET meta_template_name = 'jornada_disponivel2',
       meta_language_code = 'pt_BR',
       meta_variable_count = 0,
       meta_variable_names = NULL,
       is_active = true
...
UPDATE public.whatsapp_templates
   SET meta_template_name = 'sessao_inicio',
       meta_language_code = 'pt_BR',
       meta_variable_count = 0,
       meta_variable_names = NULL,
       is_active = true
...
UPDATE public.whatsapp_templates
   SET meta_template_name = 'welcome',
       meta_language_code = 'pt_BR',
       meta_variable_count = 0,
       meta_variable_names = NULL,
       is_active = true
...
UPDATE public.whatsapp_templates
   SET meta_template_name = 'cheking_7dias',
       meta_language_code = 'pt_BR',
       meta_variable_count = 0,
       meta_variable_names = NULL,
       is_active = true
