...
- Quando lead pedir trial via PIX: ofereça (1) trial no cartão ou (2) PIX mensal cheio sem trial. Já refletido no SYSTEM_PROMPT de `supabase/functions/support-agent/index.ts`.